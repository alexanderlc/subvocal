...
/**
 *  Initial master and seed
 */
@Profile("master-seed1")
@Configuration
public class MasterSeed1ProfileConfig {

    private static final Logger LOGGER = LoggerFactory.getLogger(MasterSeed1ProfileConfig.class);
    private static FiniteDuration workTimeout = Duration.create(10, "seconds");

    @Bean
    public ActorRef master() throws InterruptedException {

        ActorRef master = startBackend("master-seed1");
        Thread.sleep(1000);
